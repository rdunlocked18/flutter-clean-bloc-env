...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      test(
        '''should check if the device is online and return remote data when 
        the call to remote data source is successful''',
        () async {
          // arrange
          setupCaching(mockLocalDataSource);
  ...
  group('getRandomNumberTrivia', () {
    ...
    runTestsOnline(() {
      test(
        '''should check if the device is online and return remote data when the
         call to remote data source is successful''',
        () async {
          // arrange
          setupCaching(mockLocalDataSource);
...
void setupCaching(MockLocalDataSource mockLocalDataSource) {
